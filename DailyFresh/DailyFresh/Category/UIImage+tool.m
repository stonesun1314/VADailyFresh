...
- (NSString *)saveImageToTmp:(NSString *)filePath{
    NSString *imagePath = [NSTemporaryDirectory() stringByAppendingString:[NSString stringWithFormat:@"tmp%@",filePath]];
    [UIImageJPEGRepresentation(self, 0.1) writeToFile:imagePath atomically:YES];
//    [UIImagePNGRepresentation(self) writeToFile:imagePath atomically:YES];
    return imagePath;
}
@end
